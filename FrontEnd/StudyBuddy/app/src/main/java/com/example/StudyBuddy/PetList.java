...
public class PetList extends AppCompatActivity {
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(PetList.this,"Json Data is downloading",Toast.LENGTH_LONG).show();
...
//                        String office = phone.getString("office");
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(PetList.this, contactList,
                    R.layout.list_petitem, new String[]{ "name", "subtype"},
